...
<div class="greenerwp-awareness-widget <?php echo ( $position === 'absolute' ? 'greenerwp-awareness-widget--position-absolute' : '' ) ?>">
	...
	<div class="greenerwp-awareness-widget__transfer-graph">
		...
		<div class="greenerwp-awareness-widget__transfer-graph-actual">
			&nbsp;
		</div>
	</div>
	<a href="#" class="greenerwp-awareness-widget__transfer-graph-label">
		<span class="greenerwp-awareness-widget__transferMBValue"></span> MB transferred
		<span class="greenerwp-awareness-widget__help-icon" href="#">?</span>
	</a>
