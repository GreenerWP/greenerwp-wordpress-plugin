...
class GreenHosting {
  constructor() {
    ...
    this.name = __( 'Use a green hoster', 'greenerwp' );
    this.description =  __( 'Host your WordPress site on a host that uses renewable energy for its servers.', 'greenerwp' ) + ' ' +
			__( 'Have a look at the [Green Web Foundations\' green hoster directory](https://www.thegreenwebfoundation.org/directory/) to find a green host.', 'greenerwp' );
		this.guide = "hosting";
		this.steps = [
      {
        type: 'text',
        ...
        args: {
          text: __( 'Use a hoster with renewable energy.', 'greenerwp' ),
